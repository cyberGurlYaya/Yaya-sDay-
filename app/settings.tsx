...
export default function Settings() {
  ...
  return <SafeAreaView style={styles.page}><ScrollView contentContainerStyle={styles.content}>
    ...
    <Section title="Family"><Pressable style={styles.link} onPress={() => router.push('/kids')}><Text style={styles.linkTitle}>🧸 Kids Mode</Text><Text style={styles.linkCopy}>Parent-child routines, assigned tasks and progress sharing.</Text></Pressable></Section>
    <Section title="Yaya Plus"><Pressable style={styles.link} onPress={() => router.push('/premium')}><Text style={styles.linkTitle}>✨ Explore Plus</Text><Text style={styles.linkCopy}>More planning power, deeper personalization and future premium features.</Text></Pressable></Section>
