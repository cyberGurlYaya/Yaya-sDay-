...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: colors.cream }, welcome: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28 }, welcomeText: { position: 'absolute', top: '18%', color: colors.plum, fontSize: 29, fontWeight: '800' }, flowerWrap: { width: 240, height: 240, borderRadius: 120, backgroundColor: colors.babyPink, alignItems: 'center', justifyContent: 'center', shadowColor: colors.primary, shadowOpacity: 0.16, shadowRadius: 28, elevation: 8 }, flowerGlow: { position: 'absolute', width: 190, height: 190, borderRadius: 95, backgroundColor: '#FFF9F2', opacity: 0.42 }, flower: { fontSize: 120, color: colors.primary }, brand: { color: colors.plum, fontSize: 38, fontWeight: '900', marginTop: 28 }, content: { flex: 1, padding: 28, justifyContent: 'center' }, stepLabel: { color: colors.primary, fontSize: 14, fontWeight: '800', marginBottom: 12 }, title: { color: colors.plum, fontSize: 29, lineHeight: 36, fontWeight: '800' }, body: { color: colors.mutedPlum, fontSize: 16, lineHeight: 24, marginTop: 12, marginBottom: 20 }, input: { backgroundColor: colors.white, borderWidth: 1, borderColor: colors.babyPink, borderRadius: 18, paddingHorizontal: 18, paddingVertical: 16, color: colors.plum, fontSize: 17, marginTop: 8, marginBottom: 14 }, choice: { backgroundColor: colors.white, borderRadius: 18, borderWidth: 1, borderColor: '#E8DFF0', padding: 16, marginBottom: 10 }, choiceSelected: { borderColor: colors.primary, backgroundColor: '#F5F0FC' }, choiceLabel: { color: colors.plum, fontSize: 16, fontWeight: '800' }, choiceDetail: { color: colors.mutedPlum, fontSize: 13, marginTop: 4, lineHeight: 19 }, button: { backgroundColor: colors.primary, borderRadius: 18, alignItems: 'center', paddingVertical: 16, marginTop: 12 }, buttonText: { color: colors.white, fontSize: 16, fontWeight: '800' },
});
